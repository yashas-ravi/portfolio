...
const buildbox = {
  title: "BuildBox",
  discription: "no code, drag and drop website builder that helps people to build webpages and download the source code for the further development and deployment.",
  img: buildboxImg,
...
const portfolio = {
  title: "My Portfolio",
  discription: "I have built this portfolio for myself using SolidJS, watch out how i built this",
  img: logoImg,
...
const chatBot = {
  ...
  img: chatImg,
  website: "https://yashas-chat-bot.netlify.app",
